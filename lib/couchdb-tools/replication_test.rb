  ...
  class CouchTest
    ...
    def run_replication_test
      ...
      if replication_difference > 500
        ...
        mailit("couch db replication has fallen behind", "Replication is behind! DR is #{replication_difference} behind!")
      end
      
      if replication_difference > 5000
        @log.fatal "Replication is over 5000! Restarting Couchdb!!"
        mailit('couch db replication is greater than 5000. restarting couch db', "Restarting couch because its behind by #{replication_difference}")
